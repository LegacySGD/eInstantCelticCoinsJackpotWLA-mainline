...
public class CelticCoinsJackpotWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(CelticCoinsJackpotWLAEngineManagerTest.class);
		logger.setLevel(Level.DEBUG);
		gameParams = XMLUtil.parseResource("paymodel/CelticCoinsJackpotWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/CelticCoinsJackpotWLAIW/InitOutcome.xml").getDocumentElement();
